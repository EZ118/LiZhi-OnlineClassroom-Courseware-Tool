...
**提示：CID表示课件代号，accessCode表示课件访问许可码，courseUid表示教室代号**  
...
**3.在浏览器的地址栏找到“courseUId”，复制“=”号之后的第一个字符至“&”号前的第一个字符（如图）**  
<img width="881" alt="捕获" src="https://user-images.githubusercontent.com/79049368/164584235-69c660ac-6fad-44cd-85e7-fc6f9f5dfdc7.PNG">
...
**5.在弹出的黑框里的“courseUid: ”后面粘贴刚刚复制的字符串，并按下Enter键**  
